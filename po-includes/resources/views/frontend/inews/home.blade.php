...
<div class="container">
	<div class="newstricker_inner">
		<div class="trending"><strong>Pos</strong> Terbaru
		</div>
...
<section class="slider-inner" style="margin-bottom:10px;">
	<div class="container">
		<div class="row thm-margin">
			<div class="thm-padding">
				<div class="slider-wrapper">
					<div id="owl-slider" class="owl-carousel owl-theme" style="margin:0px;">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="featured-inner">
				<div id="featured-owl-rtl" class="owl-carousel">
					@foreach(getOPDPages() as $opd)
					<div class="item">
						<div class="featured-post">
							<a href="{{ url('pages/'.$opd->seotitle) }}" class="news-image"><img src="{{ getPicture($opd->picture, 'medium', $opd->updated_by) }}" alt="" class="img-responsive" style="height:120px;width:auto;margin-left: auto;margin-right: auto;"></a>
							<div class="post-text">
								<span class="post-category2">{{ $opd->title }}</span>
								<!--<h4>{{ $opd->title }}</h4>-->
							</div>
						</div>
					</div>
		...
		<div class="col-sm-12">
			<div class="featured-inner">
				<div id="featured-owl" class="owl-carousel">
					...
					<div class="item">
						<div class="featured-post">
							<a href="{{ url('album/'.$latestGallery->aseotitle) }}" class="news-image"><img src="{{ getPicture($latestGallery->picture, 'medium', $latestGallery->updated_by) }}" alt="" class="img-responsive" style="height:300px; width:100%;"></a>
							<div class="post-text">
