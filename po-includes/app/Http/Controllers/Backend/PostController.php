	...
	public function anyData()
	{
		...
		return Datatables::of($posts)
			...
			->addColumn('active', function ($post) {
				return $post->active == 'Y' ? __('post.publish') : __('post.unpublish');
			})
            ...
            ->addColumn('action', function ($post) {
				...
				// if ($post->active == 'Y'){
				// $btn .= '<a href="'.url('dashboard/posts/subscribes/'.Hashids::encode($post->id).'').'" class="btn btn-dark btn-xs btn-icon" title="'.__('general.takedown').'" data-toggle="tooltip" data-placement="left"><i class="fa fa-times fa-lg"></i></a>';
				// }else {
				//     $btn .= '<a href="'.url('dashboard/posts/subscribes/'.Hashids::encode($post->id).'').'" class="btn btn-success btn-xs btn-icon" title="'.__('general.publish').'" data-toggle="tooltip" data-placement="left"><i class="fa fa-check"></i></a>';
				// }
